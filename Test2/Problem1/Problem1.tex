            ...
            \textbf{6 edges}:\pn
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Cycles of size at most 2.}
                        ...
                        \begin{figure}[H]
                            \begin{center}
                            \includegraphics[width=5cm]{Test2/Problem1/2-2-1_0.png}
                            \end{center}                        
                        \end{figure}\pn
                        This case cannot be identically self-dual because it has loops.\pn                        
                        
                        \begin{figure}[H]
                            \begin{center}
                            \includegraphics[width=5cm]{Test2/Problem1/2-1_0-1_0.png}
                            \end{center}                        
                        \end{figure}\pn
                        This case cannot be identically self-dual because it has loops.
                        
                    \item \textbf{Cycles of size at most 3.}
                        If there is to be a triangle, and there are two blocks, there are two posibilities. First notice that there is not
                        possible to have two triangles. Then the isomorphism will map the block with the triangle two itself, or it will map
                        the block with the triangle to the other block.
                        
                        If it is mapped to itself, then the block with the triangle must have more than the trhee edges of the triangle, this
                        is because a triangle is not self-dual. Then, such block will have at least 4 edges. It cannot have 5 edges, or else
                        the block with the other edge must be mapped to itself, but there are not self-dual graphic matroids with one edge.
                        Then we have again a triangle with a parallel edge as in [\ref{t2:p1_4.png}]. Then these leads us to two new posiblilities
                        shown below.
                    ...
                    \item \textbf{Cycles of size at most 4.} 
                        ...
                        In the case of a triple edge we have a self-dual graph.
                        \begin{figure}[H]
                            \begin{center}
                            \includegraphics[width=5cm]{Test2/Problem1/4_conTriple.png}
                            \end{center}                        
                        \end{figure}\pn                        
                        This case is not identically self-dual as it has a cobasis that contains a cycle.
                        
                        And, finally, the case with two pairs of parallel edges is not self-dual. Its dual doesn't have two paris of 
                        parallel edges.
                \end{itemize}
        \item 
